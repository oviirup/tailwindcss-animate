# @oviirup/tailwindcss-animate

> A Tailwind CSS plugin for creating beautiful animations.

This is a fork of the original project [tailwindcss-animate](https://github.com/jamiebuilds/tailwindcss-animate). This fixes the issue with css-modules [^1].
